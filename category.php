...
<?php
	...
	if (isset($_GET['add'])) {
		...
		if ($hasil > 0) {
			$_SESSION['msg'] = 'Success added to featured category...';
	...
	if (isset($_GET['remove'])) {
		...
		if ($hasil > 0) {
			$_SESSION['msg'] = 'Success removed from featured category...';
			header( "Location:category.php");
			exit;	
		}
	}	
						...
						<table class='table table-hover table-striped table-offset'>
							...
							while(($count < $rpp) && ($i < $tcount)) {
								...
								<tr>
									...
									<td><img class="img-corner-radius" style="object-fit:cover;" src="upload/category/<?php echo $data['category_image']; ?>" width="60px" height="60px"/></td>
